...
class VPSGroup(app_commands.Group):
    ...
    async def deploy(self, interaction: discord.Interaction, container_name: str, ram: str = "1GB", cpu: str = "1", disk: str = "10GB", target_user: discord.Member = None):
        ...
        try:
            ...
            subprocess.call(f\"tmate -S /tmp/{container_name}.sock send-keys 'hostnamectl set-hostname DarkNodes' C-m\", shell=True)
